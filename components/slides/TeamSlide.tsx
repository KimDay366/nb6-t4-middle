...
const TEAM = [
  {
    ...
    parts: ["공용 개발 파일 제작", "인증 파트(router: /auth) - refresh 토큰 갱신", "멤버 파트 (router: /invitations)", "하위 할일 파트 (router: /subtasks)", "Oauth 구글 & 구글 캘린더 연동"],
    color: "#7FFFD4",
    img: "oy.png",
  },
  {
    ...
    parts: ["Git & Notion 관리자", "인증 파트(router: /auth) - 회원가입 ", "프로젝트 파트(router: /projects)", "댓글 파트(router: /comments)", "최종 배포"],
    color: "#E2FF00",
    img: "mh.png",
  },
  {
