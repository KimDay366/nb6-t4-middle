...
const ITEMS: TocItem[] = [
  ...
  { id: 6, title: "주요 구현 내용", desc: "Key Functions", slideId: "features" },
  { id: 7, title: "TROUBLE SHOOTING", desc: "Troubleshooting", slideId: "trouble-1" },
  { id: 8, title: "최종 목표", desc: "Final Roadmap", slideId: "roadmap" },
];
